...
describe('<BudgetSearch />', () =>{
    let budgetsearch, spygetusers, spygetuser, spyuserlogout;
    beforeEach(() => {
        budgetsearch = (
          <Provider store={mockStore}>
            ...
            <Switch>
              <Route path='/' 
              render = { props => <BudgetSearch  {...props} onGETUSERS = {spygetusers} onGETUSER = {spygetuser} UserLogOut = {spyuserlogout}  /> } />
            </Switch>
            </ConnectedRouter>
          </Provider>
        );
    ...
    it('should render Budget Search',() => {
    ...
    it('does not have a selectedUser', () => {
        ...
        expect(spyuserlogout).toBeCalledTimes(0);
